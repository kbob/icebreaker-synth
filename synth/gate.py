...
class Gate(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m.d.comb += [
            ...
            s_out.o_data.eq(Mux(gate, s_in.i_data, 0)),
...
if __name__ == '__main__':
    ...
    design.signal_outlet.leave_unconnected()
    ...
    i_velocity = Signal(7)
    m.d.comb += [
        design.signal_outlet.i_data.d.eq(i_signal),
    ...
    with Main(m).sim as sim:
        ...
        def gated_count():
            ...
            for i in range(16):
                ...
                yield
                o = (yield design.signal_inlet.o_data.d)
                assert o == (s if g1 else 0), (
                    f'clk = {i}, o = {o}, s = {s}, g1 = {g1}'
                )
                g1 = g
